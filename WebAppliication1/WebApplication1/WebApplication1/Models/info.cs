...
namespace WebApplication1.Models
{
    ...
    //    public string addr { get; set; }
        ...
        public bool verify()
        {
            SqlCommand sc = new SqlCommand("ad", connection.my_con());
        ...
        public bool verify2()
        {
            SqlCommand sc = new SqlCommand("del", connection.my_con());
            sc.CommandType = CommandType.StoredProcedure;
        ...
        public List<info> verify3()
        {
            ...
            SqlCommand sc = new SqlCommand("Show", connection.my_con());
            sc.CommandType = CommandType.StoredProcedure;
            SqlDataReader sdr = sc.ExecuteReader();
            while (sdr.Read())
            {
